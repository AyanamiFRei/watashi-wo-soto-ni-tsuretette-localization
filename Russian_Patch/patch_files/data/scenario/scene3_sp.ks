...
[font size="20"]
[font color=0xffffff]
имя >> [emb exp="f.player_name"] [r]
род занятий >> [emb exp="f.player_shokugyo"][r]
возраст >> перезаписывается
[s]
...
[font color=0xffffff]
Megic >Кто ты?[r]
Megic >Ты не Кайзаки[r]
Megic >Где ты находишься?[r]
[font color=0x00FF00]
[emb exp="f.player_name"] >[emb exp="f.whear"][r]
[font color=0xffffff]
Megic >Понятно[r]
Megic >Я расскажу, как выбраться[r]
Megic >Позови её наружу[r]
Megic >Скажи ей: «Давай выйдем наружу вместе»[r]
Megic >Верить мне или нет — тебе решать[r]
